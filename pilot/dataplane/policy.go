...
func applyClusterPolicy(cluster *envoyv2.Cluster,
...
func applyLoadBalancePolicy(cluster *envoyv2.Cluster, policy *routingv2.LoadBalancerSettings) {
...
func applyConnectionPool(cluster *envoyv2.Cluster, settings *routingv2.ConnectionPoolSettings) {
...
func applyTrafficPolicy(cluster *envoyv2.Cluster, policy *routingv2.TrafficPolicy) {
	if policy == nil {
		return
	}
...
func applyDestinationRule(config model.IstioConfigStore, cluster *envoyv2.Cluster, domain string) {
